...
- skyline_console-*.whl        the pre-built skyline-console wheel (lives at
  files/ top level, NOT inside wheels/; the charm installs it with
  --force-reinstall using wheels/ as the find-links source)
